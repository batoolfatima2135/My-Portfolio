...
export const ScrollTimeline = ({
  ...
  return (
    ...
    >
      <div className="relative max-w-6xl mx-auto mt-10 px-4 pb-24">
            ...
            <>
              ...
              >
                <motion.div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, #00fffc 0%, rgba(99,102,241,0.5) 40%, rgba(34,211,238,0) 70%)",
                    // Intense, layered glow effect for the comet
                    boxShadow: `
                      0 0 15px #00fffc,
                      0 0 25px 8px rgba(99,102,241,0.5),
