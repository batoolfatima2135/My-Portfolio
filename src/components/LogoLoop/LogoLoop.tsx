    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        if (isNodeItem) {
          ...
          const itemContent = nodeItem.href ? (
            <a
              className="logoloop__link"
              href={nodeItem.href}
              aria-label={nodeItem.ariaLabel ?? nodeItem.title ?? "logo link"}
              target="_blank"
        ...
        const itemContent = imageItem.href ? (
          <a
            className="logoloop__link"
            href={imageItem.href}
            aria-label={imageItem.alt ?? imageItem.title ?? "logo link"}
            target="_blank"
            rel="noreferrer noopener"
          >
            {content}
